...
public static void main(String[] args) throws Exception {
		...
		/* EREDITARIETA'
		 * Poichè un oggetto della classe Circle è anche un oggetto della classe GeometricShape,
		 * posso istanziare un Circle ed assegnarne il riferimento ad una variabile riferimento a
		 * GeometricShape.
		 * Ragionamento analogo vale per Triangle.
		 */
